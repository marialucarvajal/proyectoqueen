...
public class Principal {
    ...
    private void jugarPartida() {
        ...
        while(enPartida) {
            ...
            if(accionesDisponibles.isEmpty()) {
                accionesDisponibles.add("TOMAR_CARTA"); // Opción mínima disponible
            }
    ...
    private void inicializarJuego() {
        ...
        jugador1.agregarCartaMovimiento(mazoMovimiento.tomarCarta());
        jugador2.agregarCartaAtaque(mazoAtaque.tomarCarta());
    ...
    private boolean procesarAccion(String accion) {
        ...
        try {
            ...
            // No es número, continuar procesamiento normal
        }
        ...
        switch (accion) {
            case "TOMAR_CARTA":
                if (jugadorActual.getColor().equals("Rojo")) {
                    if (mazoMovimiento.estaVacio() && descarteMovimiento.estaVacio()) {
                        Imprimir.error("No hay cartas de movimiento disponibles");
                        return false;
                    }
                } else {
                    if (mazoAtaque.estaVacio() && descarteAtaque.estaVacio()) {
